...
class Dathent_Categoryreview_Block_Adminhtml_Categoryreview_Grid extends Mage_Adminhtml_Block_Widget
{
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('created_at', array(
          'header'    => Mage::helper('catalogrule')->__('Date'),
          'width'     => '130px',
          'align'     =>'left',
          'index'     => 'created_at',
      ));
      ...
      $this->addColumn('name', array(
          'header'    => Mage::helper('categoryreview')->__('First Name'),
          'align'     =>'left',
          'index'     => 'name',
      ));

      $this->addColumn('product_rew', array(
			'header'    => Mage::helper('categoryreview')->__('Product review'),
			'index'     => 'product_rew',
      ));

      $this->addColumn('shop_rew', array(
			'header'    => Mage::helper('categoryreview')->__('Review on store'),
			'index'     => 'shop_rew',
      ));
